    ...
    <body>
        <div class="container">
           <form:form cssClass="form-signin" method="post" modelAttribute="newUser" action="/spontan/user/new">
               ...
               <form:input cssClass="form-control no-radius" path="firstname" name="firstname" placeholder="First Name"/>
               <form:input cssClass="form-control no-radius" path="lastname" name="lastname" placeholder="Last Name"/>
